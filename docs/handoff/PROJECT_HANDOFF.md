...
Fase 60 tambem foi integrada e versionada em `v0.60.0`.
...
A Fase 60 foi integrada em `main` por meio da PR `#81` e versionada em `v0.60.0`.
...
A Fase 60 ja foi concluida, integrada e versionada.
